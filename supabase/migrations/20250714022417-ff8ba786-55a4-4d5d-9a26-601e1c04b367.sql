...
INSERT INTO public.chat_sessions (id, user_id, title, auto_title, message_count, created_at, updated_at)
VALUES (
  'f2b3c4d5-e6f7-4a9b-8c0d-2e3f4a5b6c7d',
  '57c3306a-52fa-48e5-a72c-3e366e112a8f',
...
INSERT INTO public.chat_sessions (id, user_id, title, auto_title, message_count, created_at, updated_at)
VALUES (
  'a3c4d5e6-f7a8-4b9c-0d1e-3f4a5b6c7d8e',
  '57c3306a-52fa-48e5-a72c-3e366e112a8f',
  'who are u...',
  'who are u',
  2,
...
SET session_id = 'e1a2b3c4-d5e6-4f8a-9b0c-1d2e3f4a5b6c'
WHERE id IN (
...
UPDATE public.messages 
SET session_id = 'f2b3c4d5-e6f7-4a9b-8c0d-2e3f4a5b6c7d'
WHERE id IN (
...
UPDATE public.messages 
SET session_id = 'a3c4d5e6-f7a8-4b9c-0d1e-3f4a5b6c7d8e'
WHERE id IN (
...
-- Additional Patois word sessions
INSERT INTO public.chat_sessions (id, user_id, title, auto_title, message_count, created_at, updated_at)
VALUES (
  gen_random_uuid(),
  '57c3306a-52fa-48e5-a72c-3e366e112a8f',
